...
#No need to modify
ARCHIVE = './regtest/nodes.tar.gz'
EXTRACT_FOLDER = 'regtest/network'
...
if __name__ == '__main__':
    ...
    # print("Re-enabling masternodes after 30 seconds")
    # time.sleep(30)
    # os.system("./start_masternodes.sh {} {}/node14".format(PASTELD_DIR, EXTRACT_PATH_FULL))
